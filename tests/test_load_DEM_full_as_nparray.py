...
from codebase.load_data import load_DEM_full_as_nparray


def test_DEM_shape() -> None:
    expected_shape = (9001, 36001)
    output_dem, output_lat, output_lon = load_DEM_full_as_nparray()
...
def test_DEM_values() -> None:
    ...
    output_dem, _, _ = load_DEM_full_as_nparray()
